...
// PA 020702
// http://groups.google.de/groups?hl=de&lr=&ie=UTF-8&safe=off&threadm=%23Braz2kW9GA.238%40uppssnewspub04.moswest.msn.net&rnum=1&prev=/groups%3Fq%3Derror%2BC2036%26hl%3Dde%26lr%3D%26ie%3DUTF-8%26safe%3Doff%26selm%3D%2523Braz2kW9GA.238%2540uppssnewspub04.moswest.msn.net%26rnum%3D1
...
SUFFIX_TREE stree_new_tree(int alphabet, int copyflag)
{
  ...
  if ((tree->strings = malloc(MAXNUMSTR * sizeof(char *))) == NULL ||
      (tree->lengths = malloc(MAXNUMSTR * sizeof(int))) == NULL ||
      (tree->ids = malloc(MAXNUMSTR * sizeof(int))) == NULL ||
...
static void *getpage(PAGETYPE type)
{
  ...
  // PA 020702
  newpage->end = (BYTE *)buffer + PAGESIZE;
  newpage->count = 0;
